...
|-------------------------|---------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PointMLP/ points = 64   | 75.954  |        | --model pointMLP --neighbours_low 8 --num_points_low 64 --workers 16 --msg points_64 --seed 0                                                                                                                             |
| PointMLP/ points = 128  | 81.090  |        | --model pointMLP --neighbours_low 16 --num_points_low 128 --workers 16 --msg points_128 --seed 0                                                                                                                          |
| PointMLP/ points = 256  | 82.616  |        | --model pointMLP --num_points_low 256 --workers 16 --msg points_256 --seed 0                                                                                                                                              |
| PointMLP/ points = 512  | 84.906  |        | --model pointMLP --num_points_low 512 --workers 16 --msg points_512 --seed 0                                                                                                                                              |
| PointMLP/ points = 1024 |         |        | --model pointMLP --num_points_low 1024 --workers 16 --msg points_1024 --seed 0                                                                                                                                            |

...
COMMAND="python -W ignore main.py --msg dual_concat_512-2048 --num_points_low 512 --num_points_high 2048 --neighbours_high 32 --neighbours_low 32 --num_channel 16 --model pointMLP --workers 16 --dual_net True  --seed 0 "
echo "$COMMAND"
$COMMAND
